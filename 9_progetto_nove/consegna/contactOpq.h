#ifndef contact_h   //Se includo piu' volte contactOpq.h, il resto di questo file
#define contact_h   //viene ignorato e quindi non avro' errori di doppie dichiarazioni
